 ...
 */
// Penjelasan
// - Cocokan apakah nilai s di shiftkan sebanyak n apakah sama dengan nilai
// goal.
// - s = abcde
...
public class E796_RotateString {
	public static void main(String[] args) {
		String example1InputS = "abcde";
		String example1InputGoal = "cdeab";
		boolean example1Output = true;

		System.err.println(solution(example1InputS, example1InputGoal) == example1Output);
	}
